...
class Evict(Quart):
   def init(self, *args, kwargs):
       ...
       self.ipc = Client(secret_key="Ng\\_3QEVfjN)U/1=FQz`58c%B4m3|&", standard_port=6060, do_multicast=False)
...
async def status():
   try:
       ...
       app.ipc = Client(secret_key="Ng\\_3QEVfjN)U/1=FQz`58c%B4m3|&", standard_port=6060, do_multicast=False)
       resp = await app.ipc.request("status")
