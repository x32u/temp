...
class settings(commands.Cog):
    ...
    async def prefix(self, ctx: EvictContext, prefix: str = None):
        ...
        if not social:
            return await ctx.warning("Social Media Reposting is not enabled.")
        if not prefix:
            return await ctx.success(f'Current prefix: {social["prefix"]}')
        await ctx.bot.db.execute(
    ...
    @Permissions.has_permission(manage_guild=True)
    async def voice(
        self, ctx: EvictContext, status: bool, channel: discord.TextChannel = None
    ):
        ...
        if status:
            if voice:
                return await ctx.warning("Voice logs are already enabled")
            if channel == None:
        ...
        if not voice:
            return await ctx.warning("Voice logs are already disabled")
        await self.bot.db.execute(
    ...
    async def message(
        ...
        if status:
            if message:
                return await ctx.warning("Message logs are already enabled")
            if channel == None:
        ...
        if not message:
            return await ctx.warning("Message logs are already disabled")
        await self.bot.db.execute(
    ...
    async def member(
        ...
        if status:
            if member:
                return await ctx.warning("member logs are already **enabled**")
            if channel == None:
        ...
        if not member:
            return await ctx.warning("member logs are already disabled")
        await self.bot.db.execute(
    ...
    async def role(
        ...
        if status:
            if role:
                return await ctx.warning("role logs are already **enabled**")
            if channel == None:
        ...
        if not role:
            return await ctx.warning("role logs are already disabled")
        await self.bot.db.execute(
    ...
    async def server(
        ...
        if status:
            if server:
                return await ctx.warning("server logs are already enabled")
            if channel == None:
        ...
        if not server:
            return await ctx.warning("server logs are already disabled")
        await self.bot.db.execute(
    ...
    async def channel(
        ...
        if status:
            if channelCheck:
                return await ctx.warning("Channel logs are already enabled")
            if channel == None:
        ...
        if not channelCheck:
            return await ctx.warning("Channel logs are already disabled")
        await self.bot.db.execute(
    ...
    async def rolebutton_remove(
        self, ctx: EvictContext, message: discord.Message, role: discord.Role
    ):
        prefix = await self.bot.get_prefix(ctx.message)
        if message.author.id != self.bot.user.id:
            return await ctx.warning(
    ...
    async def on_voice_state_update(
        ...
        if (
            ...
            embed.add_field(
                name="Switched Voice Channels", value=f"{member.mention}", inline=False
            )
            embed.add_field(
                name="IDs",
                value=f"> {member.mention} (``{member.id}``)\n > Before Channel: {before.channel.name} (``{before.channel.id}``)\n > After Channel: {after.channel.name} (``{after.channel.id}``)",
                inline=False,
            )
            embed.set_footer(
                text=member.name,
        ...
        if before.channel != after.channel and before.channel == None:
            ...
            embed.add_field(
                name="Joined a Voice Channel", value=f"{member.mention}", inline=False
            )
            embed.add_field(
                name="IDs",
        ...
        if before.channel != after.channel and after.channel == None:
            ...
            embed.add_field(
                name="Left a Voice Channel", value=f"{member.mention}", inline=False
            )
            embed.add_field(
                name="IDs",
    ...
    async def on_message_edit(self, before: discord.Message, after: discord.Message):
        ...
        embed.add_field(
            name="After message:",
            value=f"[Click to see new message]({after.jump_url})",
            inline=False,
        )
        embed.add_field(
            name="IDs",
            value=f" > Message: ``{after.id}``\n > {after.author.mention} (``{after.author.id}``)\n > {after.channel.mention} (``{after.channel.id}``)",
            inline=False,
        )
        embed.set_thumbnail(
            url=(
    ...
    async def on_member_join(self, member: discord.Member):
        ...
        embed.add_field(
            name="IDs", value=f"> {member.mention} (``{member.id}``)", inline=False
        )
        embed.set_thumbnail(
            url=(
                member.avatar.url
    ...
    async def on_member_update(self, before: discord.Member, after: discord.Member):
        ...
        if before.nick != after.nick:
            ...
            embed.add_field(
                name="Member Updated", value=f"{after.mention}", inline=False
            )
            embed.add_field(
                name="Names",
                value=f"> Old Name: {before.nick}\n > New Name: {after.nick}",
            )
            embed.add_field(
                name="IDs", value=f"> {after.mention} (``{after.id}``)", inline=False
            )
            embed.set_thumbnail(
                url=(
                    after.avatar.url
    ...
    async def on_guild_role_create(self, role: discord.Role):
        ...
        async for entry in role.guild.audit_logs(
            ...
            embed.add_field(
                name="Role Created", value=f"{role.name} | {role.mention}", inline=False
            )
            embed.add_field(
                name="IDs",
    ...
    async def on_audit_log_entry_create(self, entry: discord.AuditLogEntry):
        if entry.action == discord.AuditLogAction.member_role_update:
            ...
            embed.add_field(
                name="IDs",
                value=f"> Perp:  {entry.user.mention} (``{entry.user.id}``)\n > Target: {entry.target.mention} (``{entry.target.id}``)",
                inline=False,
            )
    ...
    async def on_guild_role_update(self, before: discord.Role, after: discord.Role):
        ...
        if before.name != after.name:
            async for entry in after.guild.audit_logs(
                ...
                embed = discord.Embed(
                    timestamp=datetime.datetime.now(), color=Colors.color
                )
                embed.set_author(
                    name=f"{entry.user}",
                    icon_url=(
                ...
                embed.add_field(
                    name="Role Updated", value=f"{after.mention}", inline=False
                )
                embed.add_field(
                    name="Names",
                    value=f"> Old Name: {before.name}\n > New Name: {after.name}",
                )
                embed.add_field(
                    name="IDs",
                ...
                embed.set_thumbnail(
                    url=(
                        entry.user.avatar.url
                        if entry.user.author.avatar is not None
                        else entry.user.default_avatar.url
                    )
                )
                embed.set_footer(
    ...
    async def on_guild_channel_create(self, after: discord.abc.GuildChannel) -> None:
        ...
        async for entry in after.guild.audit_logs(
            ...
            embed.add_field(
                name="Channel Created", value=f"{after.mention}", inline=False
            )
            embed.add_field(
                name="IDs",
                value=f"> {after.mention} (``{after.id}``)\n > {entry.user.mention} (``{entry.user.id}``)",
    ...
    async def on_guild_channel_update(
        ...
        if before.name != after.name:
            async for entry in after.guild.audit_logs(
                ...
                embed.add_field(
                    name="Channel Updated", value=f"{after.mention}", inline=False
                )
                embed.add_field(
                    name="Names",
                    value=f"> Old Name: {before.name}\n > New Name: {after.name}",
    ...
    async def on_guild_update(self, before: discord.Guild, after: discord.Guild):
        ...
        if before.name != after.name:
            async for entry in after.audit_logs(
                ...
                embed.add_field(
                    name="Server Updated", value=f"{before.name}", inline=False
                )
                embed.add_field(
                    name="Names",
                    value=f"> Old Name: {before.name}\n > New Name: {after.name}",
    ...
    async def webhook_delete(self, entry: discord.AuditLogEntry):
        ...
        if entry.action == discord.AuditLogAction.webhook_delete:
            ...
            server_logs = await self.bot.db.fetchrow(
                "SELECT * FROM server_logs WHERE guild_id = $1", entry.guild.id
            )
            if not server_logs:
                return
            ...
            embed.add_field(
                name="Webhook Deleted", value=f"{entry.user.name}", inline=False
            )
            embed.add_field(
                name="IDs",
                value=f" > {entry.user.mention} (``{entry.user.id}``)",
