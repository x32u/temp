...
async def check_vc(interaction: discord.Interaction, category: discord.CategoryChannel):
    if interaction.user.voice is None:
        await interaction.client.ext.warning(
...
class vcModal(Modal, title="Rename your voice channel"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        try:
            ...
            await interaction.client.ext.success(
                interaction,
                f"I **renamed** the voice channel to **{name}**.",
                ephemeral=True,
            )
        except Exception as er:
            await interaction.client.error(
                interaction, f"An **error** has occured.\n {er}", ephemeral=True
            )
...
class vmbuttons(discord.ui.View):
        ...
        if check is not None:
            ...
            if che is None:
                return await interaction.client.ext.warning(
                    interaction, "You **don't** own this voice channel.", ephemeral=True
                )
                ...
                await interaction.client.ext.success(
                    interaction,
                    f"I **locked** <#{interaction.user.voice.channel.id}>.",
                    ephemeral=True,
                )
    ...
    async def unlock(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        if check is not None:
            ...
            if che is None:
                ...
                await interaction.client.ext.success(
                    interaction,
                    f"I **unlocked** <#{interaction.user.voice.channel.id}>.",
                    ephemeral=True,
                )
    ...
    async def reveal(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        if check is not None:
            ...
            if che is None:
                ...
                await interaction.client.ext.success(
                    interaction,
                    f"I **revealed** <#{interaction.user.voice.channel.id}>.",
                    ephemeral=True,
                )
    ...
    async def hide(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        if check is not None:
            ...
            if che is None:
                ...
                await interaction.client.ext.success(
                    interaction,
                    f"I **hid** <#{interaction.user.voice.channel.id}>.",
                    ephemeral=True,
                )
    ...
    async def increase(
        ...
        if check is not None:
            ...
            if che is None:
                ...
                await interaction.client.ext.success(
                    interaction,
                    f"I **increased** <#{interaction.user.voice.channel.id}> limit to **{res}** members.",
                    ephemeral=True,
                )

    @discord.ui.button(
        label="",
        emoji=Emojis.decrease,
        style=discord.ButtonStyle.gray,
    ...
    async def decrease(
        ...
        if check is not None:
            ...
            if che is None:
                ...
                await interaction.client.ext.success(
                    interaction,
                    f" I **decreased** <#{interaction.user.voice.channel.id}> limit to **{res}** members.",
                    ephemeral=True,
                )
    ...
    @discord.ui.button(
        ...
        emoji=Emojis.trash,
        style=discord.ButtonStyle.gray,
        custom_id="persistent_view:trash",
    )
...
class voicemaster(commands.Cog):
    ...
    async def get_channel_categories(
        ...
        if len(channel.category.channels) == 50:
            ...
            try:
                ...
                await member.send(
                    "I **couldn't** make a new voice channel as the category is full of channels.",
                    view=view,
                )
            except:
                pass
    ...
    async def voice(self, ctx: EvictContext):
    ...
    async def unlock(self, ctx: EvictContext):
        ...
        return await ctx.success(
            f"I have **unlocked** <#{ctx.author.voice.channel.id}>"
        )

    @voice.command(
        description="rename the voice channel", usage="[name]", brief="vc owner"
    )
    @check_vc_owner()
    ...
    async def reveal(self, ctx: EvictContext):
        ...
        return await ctx.success(
            f"I have **revealed** {ctx.author.voice.channel.mention}."
        )

    @voice.command(
        description="let someone join your locked voice channel",
        usage="[member]",
        brief="vc owner",
    )
    @check_vc_owner()
    async def permit(self, ctx: EvictContext, *, member: discord.Member):
        await ctx.author.voice.channel.set_permissions(member, connect=True)
        return await ctx.success(
            f"**{member}** is allowed to join {ctx.author.voice.channel.mention}."
        )

    @voice.command(
        description="restrict someone from joining your voice channel",
        usage="[member]",
        brief="vc owner",
    )
    @check_vc_owner()
    async def reject(self, ctx: EvictContext, *, member: discord.Member):
        ...
        return await ctx.success(
            f"**{member}** not is allowed to join {ctx.author.voice.channel.mention} anymore."
        )
    ...
    @check_vc_owner()
    async def vc_kick(self, ctx: EvictContext, *, member: discord.Member):
        if member.id == ctx.author.id:
            return await ctx.reply("you **cannot** kick yourself")
        if not member in ctx.author.voice.channel.members:
            return await ctx.error(f"**{member}** isn't in **your** voice channel")
        await member.move_to(
            channel=None,
            reason=f"{ctx.member} is **not** allowed to join this voice channel.",
        )
        return await ctx.success(
            f"**{member}** got kicked from {ctx.author.voice.channel.mention}."
        )
    ...
    async def claim(self, ctx: EvictContext):
        ...
        if ctx.author.id == check[0]:
            return await ctx.warning("You are now the **owner** of this voice channel.")
    ...
    @voice.command(
        description="transfer the voice channel ownership to another member",
        usage="[member]",
        brief="vc owner",
    )
    @check_vc_owner()
    async def transfer(self, ctx: EvictContext, *, member: discord.Member):
        if not member in ctx.author.voice.channel.members:
            return await ctx.warning(f"**{member}** is not in your voice channel")
        ...
        return await ctx.success(
            f"I have **transfered** the voice ownership to **{member}**."
        )

    @commands.command(
        description="sends an updated interface of voicemaster", brief="administrator"
    )
    @Permissions.has_permission(administrator=True)
    async def interface(self, ctx: EvictContext):
        check = await self.bot.db.execute(
            "SELECT * FROM voicemaster WHERE guild_id = $1", ctx.guild.id
        )
        if check is None:
            return await ctx.warning("The voicemaster **isn't*** configured.")
    ...
    @voicemaster.command(
        description="sets voicemaster module for your server", brief="administrator"
    )
    @Permissions.has_permission(administrator=True)
    async def setup(self, ctx: EvictContext):
        check = await self.bot.db.fetchrow(
            "SELECT * FROM voicemaster WHERE guild_id = $1", ctx.guild.id
        )
        if check is not None:
            return await ctx.warning("The voicemaster is **already** configured.")
        elif check is None:
    ...
    @voicemaster.command(
        description="remove voicemaster module from your server",
        aliases=["unset"],
        brief="administrator",
    )
    @Permissions.has_permission(administrator=True)
    async def remove(self, ctx: EvictContext):
        check = await self.bot.db.fetchrow(
            "SELECT * FROM voicemaster WHERE guild_id = $1", ctx.guild.id
        )
        if check is None:
            return await ctx.warning("The voicemaster is not configured.")
