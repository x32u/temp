...
class edit(commands.Cog):
    ...
    async def ge_icon(self, ctx: EvictContext, url: str=None):
    ...
    async def ge_splash(self, ctx: EvictContext, url: str=None):
    ...
    async def ge_cover(self, ctx: EvictContext, url: str=None): 
    ...
    async def ge_name(self, ctx: EvictContext, *, name: str) -> None:
       async with ctx.typing():
    ...
    async def ge_description(self, ctx: EvictContext, *, description: typing.Optional[str] = None) -> None:
       async with ctx.typing():
    ...
    async def invites(self, ctx: EvictContext, *, invites_disabled: bool) -> None:
       async with ctx.typing():
    ...
    async def ge_discovery(self, ctx: EvictContext, *, discoverable: bool) -> None:
       async with ctx.typing():
    ...
    async def cedit(self, ctx: EvictContext): 
        return await ctx.create_pages() 
    ...
    async def ce_create(self, ctx: EvictContext, *, name: str): 
    ...
    async def ce_rename(self, ctx: EvictContext, channel: typing.Optional[discord.TextChannel] = None, *, name: str) -> None:
        if channel is None:
            channel = ctx.channel
    ...
    @Permissions.has_permission(manage_channels=True)
    async def ce_nsfw(self, ctx: EvictContext, channel: typing.Optional[discord.TextChannel] = None, *, nsfw: bool):
        if channel is None:
          channel = ctx.channel
    ...
    @Permissions.has_permission(manage_channels=True)
    async def ce_category(self, ctx: EvictContext, channel: typing.Optional[discord.TextChannel], category: discord.CategoryChannel):
    ...
    @Permissions.has_permission(manage_channels=True)
    async def ce_delete(self, ctx: EvictContext, channel: typing.Optional[discord.TextChannel] = None):
        if channel is None:
         channel = ctx.channel
    ...
    @Permissions.has_permission(manage_channels=True)
    async def ce_sync(self, ctx: EvictContext, channel: typing.Optional[discord.TextChannel], sync_permissions: bool):
        if channel is None:
         channel = ctx.channel
    ...
    @Permissions.has_permission(manage_channels=True)
    async def ce_clone(self, ctx: EvictContext, channel: typing.Optional[discord.TextChannel] = None, *, name: str) -> None:
        if channel is None:
            channel = ctx.channel
    ...
    @Permissions.has_permission(manage_channels=True)
    async def ce_topic(self, ctx: EvictContext, channel: typing.Optional[discord.TextChannel] = None, *, topic: str) -> None:
    ...
    @Permissions.has_permission(manage_channels=True) 
    async def ce_lock(self, ctx: EvictContext, channel: typing.Optional[discord.TextChannel] = None):
        if channel is None:
            channel = ctx.channel
    ...
    @Permissions.has_permission(manage_channels=True) 
    async def ce_viewlock(self, ctx: EvictContext, channel: typing.Optional[discord.TextChannel] = None):
        if channel is None:
            channel = ctx.channel
        overwrite = channel.overwrites_for(ctx.guild.default_role)
    ...
    @Permissions.has_permission(manage_channels=True) 
    async def ce_unviewlock(self, ctx: EvictContext, channel: typing.Optional[discord.TextChannel] = None):
        if channel is None:
            channel = ctx.channel
        overwrite = channel.overwrites_for(ctx.guild.default_role)
    ...
    async def redit(self, ctx: EvictContext):
       return await ctx.create_pages()
    ...
    @Permissions.has_permission(manage_roles=True) 
    async def re_hoist(self, ctx: EvictContext, role: GoodRole, state: str): 
    ...
    @Permissions.has_permission(manage_roles=True) 
    async def re_position(self, ctx: EvictContext, role: GoodRole, position: GoodRole):
    ...
    @Permissions.has_permission(manage_roles=True) 
    async def re_icon(self, ctx: EvictContext, role: GoodRole, emoji: Union[discord.PartialEmoji, str]=None):
    ...
    @Permissions.has_permission(manage_roles=True) 
    async def re_name(self, ctx: EvictContext, role: GoodRole, *, name: str): 
    ...
    @Permissions.has_permission(manage_roles=True) 
    async def re_color(self, ctx: EvictContext, role: GoodRole, *, color: str):  
        try: 
            color = color.replace("#", "")
    ...
    async def tedit(self, ctx: EvictContext):
      return await ctx.create_pages()
    ...
    async def te_create(self, ctx: EvictContext, channel: typing.Optional[discord.TextChannel] = None, message: typing.Optional[commands.MessageConverter] = None, *, name: str) -> None:
        if channel is None:
            channel = ctx.channel
    ...
    @Permissions.has_permission(manage_threads=True)
    async def te_name(self, ctx: EvictContext, thread: typing.Optional[discord.Thread], name: str) -> None:
        if thread is None:
    ...
    @Permissions.has_permission(manage_threads=True)
    async def te_archive(self, ctx: EvictContext, thread: typing.Optional[discord.Thread], archived: bool = None) -> None:
        if thread is None:
            if isinstance(ctx.channel, discord.Thread):
                thread = ctx.channel
    ...
    @Permissions.has_permission(manage_threads=True)
    async def te_bump(self, ctx: EvictContext, thread: typing.Optional[discord.Thread]) -> None:
        if thread is None:
            if isinstance(ctx.channel, discord.Thread):
                thread = ctx.channel
    ...
    @Permissions.has_permission(manage_threads=True)
    async def te_unbump(self, ctx: EvictContext, thread: typing.Optional[discord.Thread]) -> None:
        if thread is None:
            if isinstance(ctx.channel, discord.Thread):
                thread = ctx.channel
    ...
    @Permissions.has_permission(manage_threads=True)
    async def te_pin(self, ctx: EvictContext, thread: typing.Optional[discord.Thread], pinned: bool = None) -> None:
        if thread is None:
            if isinstance(ctx.channel, discord.Thread):
                thread = ctx.channel
    ...
    @Permissions.has_permission(manage_threads=True)
    async def te_invite(self, ctx: EvictContext, thread: typing.Optional[discord.Thread], invitable: bool = None) -> None:
        if thread is None:
            if isinstance(ctx.channel, discord.Thread):
                thread = ctx.channel
    ...
    @Permissions.has_permission(manage_threads=True)
    async def te_time(self, ctx: EvictContext, thread: typing.Optional[discord.Thread], time: typing.Literal["60", "1440", "4320", "10080"],) -> None:
        if thread is None:
            if isinstance(ctx.channel, discord.Thread):
                thread = ctx.channel
    ...
    @Permissions.has_permission(manage_threads=True)
    async def te_adduser(self, ctx: EvictContext, thread: typing.Optional[discord.Thread], member: discord.Member) -> None:
        if thread is None:
            if isinstance(ctx.channel, discord.Thread):
                thread = ctx.channel
    ...
    @Permissions.has_permission(manage_threads=True)
    async def te_removeuser(self, ctx: EvictContext, thread: typing.Optional[discord.Thread], member: discord.Member) -> None:
        if thread is None:
            if isinstance(ctx.channel, discord.Thread):
                thread = ctx.channel
            if discord.utils.get(await thread.fetch_members(), id=member.id) is not None:
    ...
    @Permissions.has_permission(manage_threads=True)
    async def te_delete(self, ctx: EvictContext, thread: typing.Optional[discord.Thread], invitable: bool = None) -> None:
        if thread is None:
            if isinstance(ctx.channel, discord.Thread):
                thread = ctx.channel
        await thread.delete()
    ...
    async def vedit(self, ctx: EvictContext):
      return await ctx.create_pages()
    
    @Mod.is_mod_configured()
    @vedit.command(name='create', description='create a voice channel', brief="manage channels", usage="[category] [name]")
    @Permissions.has_permission(manage_channels=True)
    async def ve_create(self, ctx: EvictContext, category: typing.Optional[discord.CategoryChannel] = None, *, name:str):
    ...
    @Permissions.has_permission(manage_channels=True)
    async def ve_name(self, ctx: EvictContext, channel: discord.VoiceChannel, name: str):
    ...
    @Permissions.has_permission(manage_channels=True)
    async def ve_nsfw(self, ctx: EvictContext, channel: discord.VoiceChannel, nsfw: bool = None):
        if nsfw is None:
    ...
    @Permissions.has_permission(manage_channels=True)
    async def ve_userlimit(self, ctx: EvictContext, channel: discord.VoiceChannel, user_limit: int):
    ...
    @Permissions.has_permission(manage_channels=True)
    async def ve_position(self, ctx: EvictContext, channel: discord.VoiceChannel, *, position: PositionConverter):
    ...
    @Permissions.has_permission(manage_channels=True)
    async def ve_sync(self, ctx: EvictContext, channel: discord.VoiceChannel, sync_permissions: bool = None):
        await channel.edit(sync_permissions=sync_permissions, reason=f"{ctx.author} has modifed {channel}.")
    ...
    @Permissions.has_permission(manage_channels=True)
    async def ve_category(self, ctx: EvictContext, channel: discord.VoiceChannel, category: discord.CategoryChannel,):
    ...
    @Permissions.has_permission(manage_channels=True)
    async def ve_delete(self, ctx: EvictContext, channel: discord.VoiceChannel) -> None:
            if channel is None:
              channel = ctx.channel
            await channel.delete(reason=f'channel deleted by {ctx.author}')
