...
class roleplay(commands.Cog):
    ...
    async def cuddle(self, ctx: EvictContext, user: discord.Member):
        ...
        embed = discord.Embed(
            colour=Colors.color,
            description=f"**{ctx.author.mention}** just cuddled **{user.mention}**!",
        )
    ...
    async def poke(self, ctx: EvictContext, user: discord.Member):
        ...
        embed = discord.Embed(
            colour=Colors.color,
            description=f"**{ctx.author.mention}** just poked **{user.mention}**!",
        )
        embed.set_author(name=self.bot.user.display_name, icon_url=self.bot.user.avatar)
        embed.set_image(url=response["image_url"])
        await ctx.reply(embed=embed)
    ...
    async def hug(self, ctx: EvictContext, user: discord.Member):
        ...
        embed = discord.Embed(
            colour=Colors.color,
            description=f"**{ctx.author.mention}** just hugged **{user.mention}**!",
        )
        embed.set_author(name=self.bot.user.display_name, icon_url=self.bot.user.avatar)
        embed.set_image(url=response["image_url"])
        await ctx.reply(embed=embed)
    ...
    async def tickle(self, ctx: EvictContext, user: discord.Member):
        ...
        embed = discord.Embed(
            colour=Colors.color,
            description=f"**{ctx.author.mention}** just tickled **{user.mention}**!",
        )
        embed.set_image(url=response["image_url"])
        await ctx.reply(embed=embed)
    ...
    async def lick(self, ctx: EvictContext, user: discord.Member):
        ...
        embed = discord.Embed(
            colour=Colors.color,
            description=f"**{ctx.author.mention}** just licked **{user.mention}**!",
        )
        embed.set_author(name=self.bot.user.display_name, icon_url=self.bot.user.avatar)
        embed.set_image(url=response["image_url"])
        await ctx.reply(embed=embed)
    ...
    async def slap(self, ctx: EvictContext, user: discord.Member):
        ...
        embed = discord.Embed(
            colour=Colors.color,
            description=f"**{ctx.author.mention}** just slapped **{user.mention}**!",
        )
        embed.set_author(name=self.bot.user.display_name, icon_url=self.bot.user.avatar)
        embed.set_image(url=response["image_url"])
        await ctx.reply(embed=embed)
    ...
    async def spank(self, ctx: EvictContext, user: discord.Member):
        ...
        embed = discord.Embed(
            colour=Colors.color,
            description=f"**{ctx.author.mention}** just spanked **{user.mention}**!",
        )
        embed.set_author(name=self.bot.user.display_name, icon_url=self.bot.user.avatar)
        embed.set_image(url=response["image_url"])
        await ctx.reply(embed=embed)
    ...
    async def feed(self, ctx: EvictContext, user: discord.Member):
        ...
        embed = discord.Embed(
            colour=Colors.color,
            description=f"**{ctx.author.mention}** just fed **{user.mention}**!",
        )
        embed.set_author(name=self.bot.user.display_name, icon_url=self.bot.user.avatar)
        embed.set_image(url=response["image_url"])
        await ctx.reply(embed=embed)
    ...
    async def punch(self, ctx: EvictContext, user: discord.Member):
        ...
        embed = discord.Embed(
            colour=Colors.color,
            description=f"**{ctx.author.mention}** just punched **{user.mention}**!",
        )
        embed.set_author(name=self.bot.user.display_name, icon_url=self.bot.user.avatar)
        embed.set_image(url=response["image_url"])
        await ctx.reply(embed=embed)
    ...
    async def highfive(self, ctx: EvictContext, user: discord.Member):
        ...
        embed = discord.Embed(
            colour=Colors.color,
            description=f"**{ctx.author.mention}** just highfived **{user.mention}**!",
        )
        embed.set_author(name=self.bot.user.display_name, icon_url=self.bot.user.avatar)
        embed.set_image(url=response["image_url"])
        await ctx.reply(embed=embed)
    ...
    async def kill(self, ctx: EvictContext, user: discord.Member):
        ...
        embed = discord.Embed(
            colour=Colors.color,
            description=f"**{ctx.author.mention}** just killed **{user.mention}**!",
        )
        embed.set_author(name=self.bot.user.display_name, icon_url=self.bot.user.avatar)
        embed.set_image(url=response["image_url"])
        await ctx.reply(embed=embed)
    ...
    async def lick(self, ctx: EvictContext, user: discord.Member):
        ...
        embed = discord.Embed(
            colour=Colors.color,
            description=f"**{ctx.author.mention}** just yeeted **{user.mention}**!",
        )
        embed.set_author(name=self.bot.user.display_name, icon_url=self.bot.user.avatar)
        embed.set_image(url=response["image_url"])
        await ctx.reply(embed=embed)
    ...
    async def nutkick(self, ctx: EvictContext, user: discord.Member):
        ...
        embed = discord.Embed(
            colour=Colors.color,
            description=f"**{ctx.author.mention}** just nutkicked **{user.mention}**!",
        )
        embed.set_author(name=self.bot.user.display_name, icon_url=self.bot.user.avatar)
        embed.set_image(url=response["image_url"])
        await ctx.reply(embed=embed)
    ...
    async def fuck(self, ctx: EvictContext, user: discord.Member):
        ...
        embed = discord.Embed(
            colour=Colors.color,
            description=f"**{ctx.author.mention}** just fucked **{user.mention}**!",
        )
        embed.set_author(name=self.bot.user.display_name, icon_url=self.bot.user.avatar)
        embed.set_image(url=response["image_url"])
        await ctx.reply(embed=embed)
