...
class automod(commands.Cog): 
    ...
    @Permissions.has_permission(manage_guild=True) 
    async def cf_unwhitelist_channel(self, ctx: EvictContext, *, channel: discord.TextChannel):
    ...
    @Permissions.has_permission(manage_guild=True)   
    async def antispam_channel(self, ctx: EvictContext, *, channel: discord.TextChannel):
    ...
    @Permissions.has_permission(manage_guild=True) 
    async def as_unwhitelist_channel(self, ctx: EvictContext, *, channel: discord.TextChannel):
    ...
    @Permissions.has_permission(manage_guild=True)   
    async def antiinvite_channel(self, ctx: EvictContext, *, channel: discord.TextChannel):
    ...
    @Permissions.has_permission(manage_guild=True) 
    async def unwhitelist_channel(self, ctx: EvictContext, *, channel: discord.TextChannel):
